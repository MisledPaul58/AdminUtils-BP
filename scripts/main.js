...
export function banUnbanMenu(p) {
    const form = new ActionFormData()
...
export function freezeUnfreeze(p) {
    const form = new ActionFormData()
...
export function seeInventoryMenu(p) {
    const playersArray = players.map(pname => pname.name);
    const form = new ActionFormData()
...
export function freecamMenu(player) {
    freeCam.init(player);
}
